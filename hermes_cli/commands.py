...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("continuity", "Inspect continuity status/reports/incidents, benchmark/external review state, or open the control panel", "Tools & Skills",
               args_hint="[status|report ...|incident ...|benchmark|external ...|panel|open]",
               subcommands=("status", "report", "incident", "benchmark", "external", "panel", "open")),
