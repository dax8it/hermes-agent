...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("continuity", "Inspect continuity benchmark and external-memory review state", "Tools & Skills",
               args_hint="[benchmark|external ...]",
               subcommands=("benchmark", "external")),
